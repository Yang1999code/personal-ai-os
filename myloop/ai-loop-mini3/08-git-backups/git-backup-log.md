...
- 2026-06-11：创建 `$HOME/Desktop/myloop/ai-loop-mini3`，准备初始化本地 git 仓库，作为 while-driven Loop 模板版本记录。
- 2026-06-11：补充 while-driven 母模板使用说明，要求真实任务优先按 `$HOME/Desktop/myloop/task-initializer.md` 初始化到目标项目下，并明确 Explorer/Tester、`status:` 字段和返回人工规则。
