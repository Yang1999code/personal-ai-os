...
- `$HOME/Desktop/myloop/ai-loop-mini2/README.md`
- `$HOME/Desktop/myloop/ai-loop-mini2/loop.md`

所以未来流程升级优先改 `$HOME/Desktop/myloop` 里的文件，不需要改 `$HOME/Desktop/myskill/myloop/SKILL.md`。
...
真实任务不建议直接写进本模板。优先参考 `$HOME/Desktop/myloop/task-initializer.md`，在目标项目下生成任务专用 Loop（循环）。
